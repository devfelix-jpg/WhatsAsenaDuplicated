...
Asena.addCommand({pattern: 'colorai', fromMe: true, deleteCommand: false, dontAddCommandList: true}, (async (message, match) => {    
    ...
    ffmpeg(location)
        ...
        .on('end', async () => {
            ...
            await message.sendMessage(Buffer.from(respoimage.data), MessageType.image, {mimetype: Mimetype.jpg, caption: 'Made for FelixBlack'})
...
Asena.addCommand({pattern: 'colorvideoai', fromMe: true, deleteCommand: false, dontAddCommandList: true}, (async (message, match) => {    
